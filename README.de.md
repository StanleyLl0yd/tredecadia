...
> **Aktuelle öffentliche Version: `1.0.0-rc.1`.** Das ist ein Release Candidate: Die v1-Kompatibilitätsfläche ist bereits eingefroren, vor `v1.0.0` läuft aber noch eine Beobachtungs- und Prüfphase.
...
Tredecadia verwendet eine durchgehende ganzzahlige Jahresachse mit einem echten **Jahr 0**. Eine interne Trennung in BCE/CE ist daher nicht nötig.

Mathematischer Ursprung:

`TE 00000-EQ ↔ astronomisches gregorianisches Jahr -9999, 20. März`

Das entspricht dem, was üblicherweise als **10000 BCE** bezeichnet wird. Dieser Nullpunkt soll weder den Beginn der Menschheit noch der Zivilisation oder irgendeines historischen Prozesses markieren; er ist ausschließlich der mathematische Ursprung der Jahreskoordinate.

Für die zivile Umrechnung gilt:

`TE-Jahr = astronomisches gregorianisches Jahr + 9999`

Damit entspricht 2026 dem Jahr **TE 12025**.
...
Benutzeroberflächen dürfen führende Nullen weglassen und ein typografisches Minus verwenden. Das sind Darstellungsformen, keine alternativen kanonischen Bezeichner.

## Monate

| # | Name | Short-6 | Short-4 |
|---:|---|---|---|
...
Im Gespräch ist die Vier-Buchstaben-Form die bevorzugte Kurzform, sobald aus dem Kontext klar ist, dass ein Monat gemeint ist. Die Referenzaussprache hat **eine leichte Hervorhebung der ersten Silbe**; Betonung ist nicht Teil der Namensidentität.
...
Dieses README ist als natürlich lesbare deutsche Einführung gedacht und ersetzt nicht die normative Spezifikation.
