...
from release_state import citation_version, is_prerelease
...
def main():
 version=citation_version(); r=t('README.md'); site=t('docs/index.md'); n=t('specification/month-naming-standard.md'); l=t('specification/localization.md'); lp=t('specification/localization-profiles.md')
 for m in MONTHS:
