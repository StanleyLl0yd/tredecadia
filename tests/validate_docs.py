...
def main():
 ...
 docs='\n'.join(t(p) for p in ['README.md','ROADMAP.md','specification/calendar-standard.md','specification/conversion-standard.md','specification/date-notation.md','specification/month-naming-standard.md','specification/localization.md','specification/localization-profiles.md','rationale/design.md','rationale/pronunciation.md','rationale/short4-ux.md'])
 ...
 for required in ['Tredecadia Era','year `0`','10000 BCE','Y - 9999','Y - 9998','astronomical','weak initial prominence','Short-4','candidate','reviewed','stable']: assert required in docs
