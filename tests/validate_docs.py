...
def main():
 ...
 for required in ['Tredecadia Era','year `0`','10000 BCE','Y - 9999','Y - 9998','astronomical','weak initial prominence','Short-4','candidate','reviewed','stable','ASCII decimal digits','Accessible semantic labels','Unicode MINUS SIGN','palatalization','compatibility-critical','release-candidate']: assert required in docs
 ...
 assert sum(p['review']['status']=='reviewed' for p in LOC['profiles']) >= 3
